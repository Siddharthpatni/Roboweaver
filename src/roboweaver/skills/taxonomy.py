...
def get_industrial_skill_template(
    ...
    builder = _BUILTIN_TEMPLATE_BUILDERS.get(category)
    if builder is not None:
        return builder(category, target_name)
    return _create_generic_custom_template(str(category), target_name)


def _build_pick_and_place_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_tighten_bolt_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_open_door_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_tool_exchange_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_inspect_surface_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_weld_seam_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_palletizing_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_polishing_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_disassembly_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_mobile_nav_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_pegging_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_pouring_liquid_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_packaging_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_cnc_loading_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_surgery_assist_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_sorting_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
def _build_cleaning_template(category: IndustrialSkillCategory, target_name: str) -> IndustrialSkillTemplate:
    tasks = [
...
_BUILTIN_TEMPLATE_BUILDERS = {
    IndustrialSkillCategory.PICK_AND_PLACE: _build_pick_and_place_template,
    IndustrialSkillCategory.TIGHTEN_BOLT: _build_tighten_bolt_template,
    IndustrialSkillCategory.OPEN_DOOR: _build_open_door_template,
    IndustrialSkillCategory.TOOL_EXCHANGE: _build_tool_exchange_template,
    IndustrialSkillCategory.INSPECT_SURFACE: _build_inspect_surface_template,
    IndustrialSkillCategory.WELD_SEAM: _build_weld_seam_template,
    IndustrialSkillCategory.PALLETIZING: _build_palletizing_template,
    IndustrialSkillCategory.POLISHING: _build_polishing_template,
    IndustrialSkillCategory.DISASSEMBLY: _build_disassembly_template,
    IndustrialSkillCategory.MOBILE_NAV: _build_mobile_nav_template,
    IndustrialSkillCategory.PEGGING: _build_pegging_template,
    IndustrialSkillCategory.POURING_LIQUID: _build_pouring_liquid_template,
    IndustrialSkillCategory.PACKAGING: _build_packaging_template,
    IndustrialSkillCategory.CNC_LOADING: _build_cnc_loading_template,
    IndustrialSkillCategory.SURGERY_ASSIST: _build_surgery_assist_template,
    IndustrialSkillCategory.SORTING: _build_sorting_template,
    IndustrialSkillCategory.CLEANING: _build_cleaning_template,
}
